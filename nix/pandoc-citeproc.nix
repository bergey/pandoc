{ system
  ...
  , ... }:
  {
    ...
    package = {
      specVersion = "1.12";
      identifier = { name = "pandoc-citeproc"; version = "0.17"; };
    ...
    components = {
      ...
      exes = {
        ...
        "test-citeproc" = {
          ...
          build-tools = [
            (hsPkgs.buildPackages.pandoc-citeproc or (pkgs.buildPackages.pandoc-citeproc or (errorHandler.buildToolDepError "pandoc-citeproc")))
            ];
    ...
    src = (pkgs.lib).mkDefault (pkgs.fetchgit {
      ...
      rev = "2e6fe791ec5293acc925c2ccbe79c9c10d2b7e07";
      sha256 = "0sz3232m0cw5g0jmw2s2944nl24yfh3218sd8yy78jx1lqiic70p";
      });
    }